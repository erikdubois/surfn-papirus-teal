...
and ship as `surfn-papirus-teal-icons-git`, depending on `surfn-icons-git`.

### Files Modified

- Initial scaffold + usr/share/icons/Surfn-Papirus-Teal/
...
- usr/share/icons/Surfn-Papirus-Teal/{16x16,22x22,24x24,32x32,48x48,64x64}/places/folder-publicshare.svg (new)
...
- usr/share/icons/Surfn-Papirus-Teal/{16x16,22x22,24x24,32x32,48x48,64x64}/places/user-desktop.svg (new)
